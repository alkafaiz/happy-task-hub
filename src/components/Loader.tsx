...
function Loader({ totalFiles, progression }: LoaderProps) {
    return (
        <div
            id="loader"
        ...
        >
            <div className="text-center">
                ...
                <br />
                <span className="">
                    Loading... <span className="text-xl font-bold">{progression}%</span>
                    <br />
                    Generating {totalFiles} {totalFiles > 1 ? 'documents' : 'document'}
                </span>
            </div>
        </div>
    );
